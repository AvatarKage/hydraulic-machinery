...
execute \
    if data block ~ ~2 ~ Items[{id:"minecraft:blaze_rod"}] \
    run scoreboard players set @s hydraulic_machinery.fuel_type 1

execute \
    if data block ~ ~2 ~ Items[{id:"minecraft:lava_bucket"}] \
...
execute \
    ...
    run tellraw @p ["",{color:"#e77b57",text:"[Hydraulic Machinery] "},"Heat press out of fuel!"]
...
execute \
    ...
    if data block ~ ~2 ~ Items[{Slot:0b,id:"minecraft:blaze_rod"}] \
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:1b,id:"minecraft:blaze_rod"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:2b,id:"minecraft:blaze_rod"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:3b,id:"minecraft:blaze_rod"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:4b,id:"minecraft:blaze_rod"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    ...
    if data block ~ ~2 ~ Items[{Slot:0b,id:"minecraft:lava_bucket"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    ...
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:0b,id:"minecraft:lava_bucket"}] \
    run item replace block ~ ~2 ~ container.0 with minecraft:bucket
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:1b,id:"minecraft:lava_bucket"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    ...
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:1b,id:"minecraft:lava_bucket"}] \
    run item replace block ~ ~2 ~ container.1 with minecraft:bucket
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:2b,id:"minecraft:lava_bucket"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    ...
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:2b,id:"minecraft:lava_bucket"}] \
    run item replace block ~ ~2 ~ container.2 with minecraft:bucket
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:3b,id:"minecraft:lava_bucket"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    ...
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:3b,id:"minecraft:lava_bucket"}] \
    run item replace block ~ ~2 ~ container.3 with minecraft:bucket
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:4b,id:"minecraft:lava_bucket"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    ...
    if score @s hydraulic_machinery.fuel_type matches 2 \
    if data block ~ ~2 ~ Items[{Slot:4b,id:"minecraft:lava_bucket"}] \
    run item replace block ~ ~2 ~ container.4 with minecraft:bucket
...
execute \
    as @s[tag=hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    run scoreboard players set @s hydraulic_machinery.fuel_level 32

execute \
    as @s[tag=hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 2 \
    run scoreboard players set @s hydraulic_machinery.fuel_level 200
