...
execute \
    if data block ~ ~2 ~ Items[{id:"minecraft:bone_meal"}] \
...
execute \
    ...
    run tellraw @p ["",{color:"#e77b57",text:"[Hydraulic Machinery] "},"Mushroom press out of fuel!"]
...
execute \
    ...
    if data block ~ ~2 ~ Items[{Slot:0b,id:"minecraft:bone_meal"}] \
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:1b,id:"minecraft:bone_meal"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:2b,id:"minecraft:bone_meal"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:3b,id:"minecraft:bone_meal"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:4b,id:"minecraft:bone_meal"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
