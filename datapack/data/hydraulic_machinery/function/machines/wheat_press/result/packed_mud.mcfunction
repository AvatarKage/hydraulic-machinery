...
execute \
    ...
    run function hydraulic_machinery:management/refuel/wheat_press
...
setblock ~ ~-2 ~ minecraft:packed_mud

playsound block.mud.break block @a[distance=..12] \
    ~ ~-2 ~ 1 0.5

particle minecraft:block{block_state:"minecraft:packed_mud"} \
