...
setblock ~ ~-2 ~ minecraft:gilded_blackstone

playsound block.gilded_blackstone.break block @a[distance=..12] \
    ~ ~-2 ~ 1 0.5

particle minecraft:block{block_state:"minecraft:gilded_blackstone"} \
