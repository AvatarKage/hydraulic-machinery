...
execute \
    if data block ~ ~2 ~ Items[{id:"minecraft:rotten_flesh"}] \
...
execute \
    ...
    run tellraw @p ["",{color:"#e77b57",text:"[Hydraulic Machinery] "},"Sculk press out of fuel!"]
...
execute \
    ...
    if data block ~ ~2 ~ Items[{Slot:0b,id:"minecraft:rotten_flesh"}] \
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:1b,id:"minecraft:rotten_flesh"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:2b,id:"minecraft:rotten_flesh"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:3b,id:"minecraft:rotten_flesh"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=!hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    if data block ~ ~2 ~ Items[{Slot:4b,id:"minecraft:rotten_flesh"}] \
    run tag @s add hydraulic_machinery_found_fuel_item
...
execute \
    as @s[tag=hydraulic_machinery_found_fuel_item] \
    if score @s hydraulic_machinery.fuel_type matches 1 \
    run scoreboard players set @s hydraulic_machinery.fuel_level 10
