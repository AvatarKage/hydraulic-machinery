...
execute \
    ...
    run function hydraulic_machinery:management/refuel/sculk_press
...
setblock ~ ~-2 ~ minecraft:sculk

playsound block.sculk.charge block @a[distance=..12] \
    ~ ~-2 ~ 1 0.5

particle minecraft:sculk_charge{roll:1} \
