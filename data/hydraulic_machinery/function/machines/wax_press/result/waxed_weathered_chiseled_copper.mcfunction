...
execute \
    ...
    run function hydraulic_machinery:management/refuel/wax_press
...
setblock ~ ~-2 ~ minecraft:waxed_weathered_chiseled_copper

playsound item.honeycomb.wax_on block @a[distance=..12] \
    ~ ~-2 ~ 1 0.5
